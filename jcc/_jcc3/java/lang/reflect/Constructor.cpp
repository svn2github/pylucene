...
namespace java {
    namespace lang {
        namespace reflect {
            ...
            static PyType_Slot PY_TYPE_SLOTS(Constructor)[] = {
                { Py_tp_methods, t_Constructor__methods_ },
                { Py_tp_init, (void *) abstract_init },
                { 0, 0 }
            };

            static PyType_Def *PY_TYPE_BASES(Constructor)[] = {
                &PY_TYPE_DEF(Object),
                NULL
            };

            DEFINE_TYPE(Constructor, t_Constructor, Constructor);
